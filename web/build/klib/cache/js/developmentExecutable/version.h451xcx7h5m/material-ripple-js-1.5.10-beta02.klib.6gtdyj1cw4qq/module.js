(function (root, factory) {
  ...
  var Companion_getInstance_0 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.d3;
  ...
  var Indication = kotlin_org_jetbrains_compose_foundation_foundation.$_$.v;
  var IndicationInstance = kotlin_org_jetbrains_compose_foundation_foundation.$_$.u;
  ...
  var lastOrNull = kotlin_kotlin.$_$.n6;
  ...
  var CompletableDeferred = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.z;
  ...
  protoOf(CommonRipple).rememberUpdatedRippleInstance$composable_8600sf_k$ = function (interactionSource, bounded, radius, color, rippleAlpha, $composer, $changed) {
    ...
    var tmp1_cache = !!($composer_1.changed_ga7h3f_k$(interactionSource) | $composer_1.changed_ga7h3f_k$(this));
  ...
  protoOf(CommonRippleIndicationInstance).addRipple_csj8jr_k$ = function (interaction, scope) {
    ...
    this.ripples_1.put_3mhbri_k$(interaction, rippleAnimation);
  ...
  function rememberRipple$composable(bounded, radius, color, $composer, $changed, $default) {
    ...
    sourceInformation($composer_1, 'CC(remember$composable)P(1,2):Composables.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    var tmp1_cache = !!($composer_1.changed_ga7h3f_k$(tmp0_remember$composable) | $composer_1.changed_ga7h3f_k$(new Dp(tmp1_remember$composable)));
    // Inline function 'kotlin.let' call
    var tmp0_let = $composer_1.rememberedValue_4dg93v_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
  ...
  protoOf(Ripple).rememberUpdatedInstance$composable_3l23r4_k$ = function (interactionSource, $composer, $changed) {
    ...
    var tmp2_get_isSpecified_v6ii6t = this.color_1.get_value_j01efc_k$().value_1;
    if (!equals(_Color___get_value__impl__1pls5m(tmp2_get_isSpecified_v6ii6t), _Color___get_value__impl__1pls5m(Companion_getInstance_1().get_Unspecified_9ntdt9_k$()))) {
  ...
  protoOf(RippleIndicationInstance).drawStateLayer_mkuc2c_k$ = function (_this__u8e3s4, radius, color) {
    // Inline function 'kotlin.with' call
    // Inline function 'kotlin.contracts.contract' call
    this.stateLayer_1.drawStateLayer_mkuc2c_k$(_this__u8e3s4, radius, color);
  };
  ...
  protoOf(StateLayer).drawStateLayer_mkuc2c_k$ = function (_this__u8e3s4, radius, color) {
    ...
    if (alpha > 0.0) {
      ...
      if (this.bounded_1) {
        ...
        var tmp2_clipRect = Companion_getInstance_2().get_Intersect_ow3v69_k$();
  ...
  function _get_finishedFadingIn__pzmnej($this) {
    ...
    return $this.finishedFadingIn$delegate_1.get_value_j01efc_k$();
  }
  ...
  function _get_finishRequested__usb5ii($this) {
    ...
    return $this.finishRequested$delegate_1.get_value_j01efc_k$();
  }
  ...
  protoOf(RippleAnimation).draw_opvrg2_k$ = function (_this__u8e3s4, color) {
    ...
    if (this.targetRadius_1 == null) {
      ...
      var tmp_0;
      // Inline function 'androidx.compose.ui.unit.isUnspecified' call
      var tmp0_get_isUnspecified_nagfjk = this.radius_1;
    ...
    if (this.bounded_1) {
      ...
      var tmp3_clipRect = Companion_getInstance_2().get_Intersect_ow3v69_k$();
      // Inline function 'androidx.compose.ui.graphics.drawscope.withTransform' call
      // Inline function 'kotlin.with' call
      var tmp0_with = _this__u8e3s4.get_drawContext_ffwztu_k$();
      // Inline function 'kotlin.contracts.contract' call
      ...
      tmp0_with.get_canvas_bshgm9_k$().save_erlm4_k$();
      // Inline function 'androidx.compose.ui.graphics.drawscope.clipRect.<anonymous>' call
      tmp0_with.get_transform_px941v_k$().clipRect_si0ig1_k$(0.0, 0.0, tmp1_clipRect, tmp2_clipRect, tmp3_clipRect);
